...
export const GenerateAi = async(title,article,userSelect) => {
      const generatePrompt = () => {
            switch (userSelect) {
                  ...
                  case 2:
                        return `${title} ${article} Analyze the content from the provided dev.to article and craft a tweet that is concise, engaging, and suitable for Twitter (max 250 characters). Ensure the tweet captures the essence of the article's key insights and entices users to click through and read more`
                  case 3:
